...
function StatIcon({ type, color }: { type: string; color: string }) {
  const iconColor =
    color === "blue" ? "#2563ff" : color === "orange" ? "#ff5b16" : "#05ad4f";
  ...
  if (type === "users") {
    return (
      <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
        ...
        <path
          d="M7 28V25C7 20.8 10.4 18 16 18C21.6 18 25 20.8 25 25V28"
          stroke={iconColor}
          strokeWidth="2.8"
          strokeLinecap="round"
        />
        ...
        <path
          d="M27 20C30.2 20.7 32 23 32 26V28"
          stroke={iconColor}
          strokeWidth="2.8"
          strokeLinecap="round"
        />
  ...
  return (
    <svg width="27" height="27" viewBox="0 0 34 34" fill="none">
      ...
      <path
        d="M12 18L10 31L17 27L24 31L22 18"
        stroke={iconColor}
        strokeWidth="2.8"
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    <div className="mx-auto w-[340px] rounded-[10px] border border-gray-200 bg-white px-[26px] py-[22px] shadow-[0_2px_6px_rgba(0,0,0,0.16)]">
      <div className="flex items-start gap-[16px]">
        <div
          className={`flex h-[42px] w-[42px] shrink-0 items-center justify-center rounded-full ${bg}`}
        >
          <StatIcon type={item.type} color={item.color} />
        </div>

        <div className="flex flex-col items-start text-left">
          <p className="text-[15px] font-medium leading-none text-[#4b5563]">
            {item.title}
          </p>
          <p className="mt-[8px] text-[17px] font-extrabold leading-none text-black">
            {item.score}
          </p>
        </div>
      </div>
      ...
      <div className="flex items-end gap-17">
        ...
        {item.percent && (
          <div
            className={`flex items-center gap-[1px] ${item.trend === "up" ? "text-[#05B547]" : "text-[#FF2A2A]"}`}
          >
    ...
    <div ref={chartRef} className="mt-4">
      ...
      <svg viewBox="0 0 390 315" className="mx-auto block h-[315px] w-full">
        <g transform="translate(195 160)">
          <polygon
            points="0,-104 90,-52 90,52 0,104 -90,52 -90,-52"
            fill="none"
            stroke="#d6d6d6"
            strokeWidth="1.5"
          />
          <polygon
            points="0,-69 60,-34.5 60,34.5 0,69 -60,34.5 -60,-34.5"
            fill="none"
            stroke="#d6d6d6"
            strokeWidth="1.2"
          />
          <polygon
            points="0,-34.5 30,-17.2 30,17.2 0,34.5 -30,17.2 -30,-17.2"
            fill="none"
            stroke="#d6d6d6"
            strokeWidth="1.2"
          />
          ...
          <text x="6" y="-98" fontSize="11" fill="#c6c6c6">
            10
          </text>
          <text x="6" y="-63" fontSize="11" fill="#c6c6c6">
            6
          </text>
          <text x="6" y="-28" fontSize="11" fill="#c6c6c6">
            3
          </text>
          <text x="6" y="5" fontSize="11" fill="#c6c6c6">
            0
          </text>
          ...
          <polygon
            ...
            style={{
              ...
              transition:
                "transform 3800ms cubic-bezier(0.22, 1, 0.36, 1), opacity 1200ms ease",
            }}
          />

          <text x="0" y="-126" textAnchor="middle" fontSize="14" fill="#8f96a3">
            다년간의 경험
          </text>
          <text
            x="133"
          ...
          <text x="137" y="59" textAnchor="middle" fontSize="14" fill="#8f96a3">
            대외활동
          </text>
          <text x="0" y="132" textAnchor="middle" fontSize="14" fill="#8f96a3">
            리더십
          </text>
          <text
            x="-137"
    ...
    <div className="flex min-h-screen justify-center bg-[#eef0fa]">
      <div className="relative h-screen w-full max-w-[430px] overflow-hidden bg-white">
        ...
        >
          ...
          <section className="mx-auto mt-[14px] w-full max-w-[400px] rounded-[24px] border border-gray-200 bg-white px-5 py-4 shadow-sm">
            <h2 className="px-3 py-3 text-[18px] font-extrabold text-black">
              합격자 분석 DB
            </h2>
                ...
                <tbody>
                  {rows.map((row, index) => (
                    <tr key={row[0]} className="border-t border-gray-100">
                      <td className="py-3 pl-2 text-left font-bold text-gray-700">
                        {row[0]}
                      </td>
                      <td>
                        <span className="rounded-full bg-blue-100 px-1 py-1 text-blue-600">
                          {row[1]}
                        </span>
                      </td>
                      ...
                      <td>
                        <div
                          className={`flex items-center justify-center gap-[1px] ${row[4] === "up" ? "text-[#05B547]" : "text-[#FF2A2A]"}`}
                        >
