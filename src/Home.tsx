  ...
  return (
    <div className="home-container">
      ...
      <section className="hero-section">
        <img src={orbitImg} alt="" className="orbit-decoration" />
        <img src={ellipseImg} alt="" className="ellipse-dot ellipse-dot-1" />
        <img src={ellipseImg} alt="" className="ellipse-dot ellipse-dot-2" />

        <div className="hero-content">
          <h1 className="hero-title-black">AI의 객관적 지표, 현직자의 경험을 잇다</h1>
          <h1 className="hero-title-gradient">단 하나의 취준 성공 궤도</h1>
          <p className="hero-description">
            "AI가 설계하는 객관적 로드맵과 데이터 지표, 여기에 현직자와의 실무 커피챗을 더해 당신의
            성장을 완벽하게 서포트합니다. 지금 바로 나만의 맞춤형 커리어 로드맵을 확인하세요."
          </p>
      ...
      <section className="how-section">
        ...
        <p className="how-subtitle">
          뾰각이 길잃은 취준의 <span className="highlight">방향성</span>을 찾아주는 방법
        </p>
        <div className="features-grid">
          <div className="feature-card">
            <div className="feature-orb">
              <img src={ellipseImg} alt="" className="feature-orb-img" />
              <span>01</span>
            </div>
